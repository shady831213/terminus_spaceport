...
gcc -g test_raw_allocator.c -ldpi_memory.1 -L../target/release -Wl,-rpath=../target/release -I ../csrc -o test
./test
rm test
...
gcc -g test_region.c -ldpi_memory.1 -L../target/release -Wl,-rpath=../target/release -I ../csrc -o test
